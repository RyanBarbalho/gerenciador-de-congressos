...
from ..strategies.interfaces import CompatibilidadeStrategy, CompatibilidadePadrao, Validator, ValidatorPadrao
...
class AlocadorBuilder:
    ...
    def construir(self) -> 'AlocadorSalasRefatorado':
        ...
        if self._compatibilidade_strategy is None:
            self._compatibilidade_strategy = CompatibilidadePadrao()
